...
>
  ...
  <!-- Title -->
  <div style="margin-bottom: 30px; font-size: 48px; font-weight: bold; line-height: 1.2;">
    <TranslatedTextWithOriginal segments={story.title} inline />
  </div>

  <!-- Content excerpt -->
  <div style="margin-bottom: 40px; font-size: 24px; line-height: 1.6; color: {textMuted}; max-height: 300px; overflow: hidden;">
  ...
  <div style="position: absolute; bottom: 60px; left: 60px; right: 60px;">
    ...
    <div style="font-size: 16px; color: {textMuted}; margin-top: 8px;">
